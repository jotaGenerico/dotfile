...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Visual ctermbg=NONE ctermfg=98 cterm=reverse guibg=#111111 guifg=#bd93f9 gui=reverse
    ...
    hi IncSearch ctermbg=46 ctermfg=0 cterm=NONE guibg=#003b4f guifg=#000000 gui=NONE
    hi Search ctermbg=98 ctermfg=232 cterm=NONE guibg=#222222 guifg=#003b4f gui=NONE
